...
To choose the number of modes and channels relative to FNO, the extra parameters in _G_-FNO kernels added by the stabilizer dimension should be offset by reducing the number of channels (**as opposed to the number of modes**) as discussed in [Appendix A.2](https://icml.cc/virtual/2023/poster/23875) and Section 8.2 of [Cohen and Welling (2016)](https://arxiv.org/abs/1602.07576).

## Introduction

This is the official implementation of _G_-FNO:
...
Below are commands for training _G_-FNO2d-_p4_ on each of the datasets.
